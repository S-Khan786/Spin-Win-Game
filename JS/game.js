let prizes_config = {
    ...
    count:12,
    prize_names : ["3000 credits", "35% Off", "Hard Luck", "70% Off", "Swagpack", "100% Off", "Netlfix", "50% Off", "Amazon Voucher", "2 Extra Spin", "CB Tshirt", "CB Book"]
}
...
function spinwheel() {
    console.log("You clicked on the mouse");
